...
contract Timelock {
    ...
    uint public constant CONFIRMATIONS_REQUIRE = 3;
    ...
    constructor(address[] memory _owners) {
        ...
        {       
            ...
            require(nextOwner != address(0), "owner address cant be zero");
            require(!isOwner[nextOwner], "dublicate owners");
    ...
    function addToQueue(
        ...
        require(_timestamp > block.timestamp + MINIMUM_DELAY &&
                _timestamp < block.timestamp + MAXIMUM_DELAY, "timestamp incorrect");
